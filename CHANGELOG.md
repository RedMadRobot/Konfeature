...
- `konfeature` now publishes for every target Kotlin supports: JVM, `js`, `wasmJs`, `wasmWasi`, all Apple targets (iOS, macOS, tvOS, watchOS — `iosX64` dropped in 1.1.0 is back), Linux, Windows (`mingwX64`) and Android Native
